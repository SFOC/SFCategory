...
- (void)setTarget:(id)target
  ...
  for (id currentTarget in targets) {
    NSArray *actions =
        [self actionsForTarget:currentTarget forControlEvent:controlEvents];
...
- (void)addBlockForControlEvents:(UIControlEvents)controlEvents
  ...
  _YYUIControlBlockTarget *target =
      [[_YYUIControlBlockTarget alloc] initWithBlock:block
...
- (NSMutableArray *)_yy_allUIControlBlockTargets {
  ...
  if (!targets) {
    ...
    objc_setAssociatedObject(self, &block_key, targets,
