...
- (void)drawRect:(CGRect)rect {
    ...
    rect = self.frame;
    CGFloat textWidth = [self widthReturnWithHeight:self.frame.size.height font:self.font.pointSize text:self.text] + 3;
